...
constexpr const char *USAGE_MSG =
    ...
    "    -n N swcFile2 [swcFile2 ...]                   # produce random "
    "pairs, ad infinitum if number of random pairs == -1, prints a .sin file "
    "to stdout |\n"
    "    -s sinFile                                     # turn a sin file into "
    "a p-value matrix, produces a .matrix file |\n"
    "    -r randomPairMatrixFile                        # read in the random "
    "pair matrix file\n"
    "    -m matchPairMatrixFile                         # read in the match "
    "pair matrix file\n"
    "    -c                                             # Calculate cosine "
